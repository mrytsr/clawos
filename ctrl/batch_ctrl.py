...
def register_batch(app):
    ...
    def batch_delete():
        ...
        return api_ok({'deleted': deleted, 'errors': errors, 'message': f'已删除 {len(deleted)} 个项目'})
    ...
    def batch_copy():
        ...
        return api_ok({'copied': copied, 'errors': errors, 'message': f'已复制 {len(copied)} 个项目'})
    ...
    def batch_move():
        ...
        return api_ok({'moved': moved, 'errors': errors, 'message': f'已移动 {len(moved)} 个项目'})
